...
class Filter:
    ...
    def get_method(self, qs: models.QuerySet[_MT_co]) -> Callable[..., models.QuerySet[_MT_co]]: ...
    method: Callable = ...
    label: Any = ...
    @property
    def field(self): ...
    def filter(self, qs: models.QuerySet[_MT_co], value: Any) -> models.QuerySet[_MT_co]: ...
